...
export default function HomePage() {
  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center bg-[#071325] text-white overflow-hidden py-24">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-xs font-medium text-[#d4af37]">
          ...
          {/* Search Box Card */}
          <div className="bg-white text-slate-900 rounded-2xl p-6 shadow-2xl max-w-4xl mx-auto text-left border border-slate-200">
            {/* Buy / Rent Tabs */}
            <div className="flex gap-2 border-b border-slate-200 pb-4 mb-4">
              <button className="px-5 py-2 rounded-lg font-semibold text-sm bg-[#0a192f] text-white">
                Buy
              </button>
              <button className="px-5 py-2 rounded-lg font-semibold text-sm bg-slate-100 text-slate-700 hover:bg-slate-200">
                Rent
              </button>
              <button className="px-5 py-2 rounded-lg font-semibold text-sm bg-slate-100 text-slate-700 hover:bg-slate-200">
                Sold
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="md:col-span-2 space-y-1">
                <label className="text-xs font-semibold uppercase text-slate-500">Location / Suburb</label>
                <div className="relative">
                  <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                  <input
                    type="text"
                    placeholder="Search Parramatta, Bondi Beach, Manly, 2150..."
                    className="w-full pl-9 pr-4 py-2.5 bg-slate-50 rounded-lg text-sm border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0a192f]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <select className="w-full py-2.5 px-3 bg-slate-50 rounded-lg text-sm border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0a192f]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#0a192f] mt-1">
              Featured Australian Listings
            </h2>
          </div>
          <Link href="/buy" className="text-sm font-semibold text-[#0a192f] hover:text-[#c5a059] flex items-center gap-1">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl navy-gradient p-8 sm:p-14 text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-slate-300 text-base font-light max-w-lg">
            ...
            <div className="bg-white text-slate-900 rounded-2xl p-6 shadow-xl space-y-4">
              <h3 className="font-serif text-xl font-bold text-[#0a192f]">Get Your Free Property Estimate</h3>
              <div className="space-y-3">
                <input
                  type="text"
                  placeholder="Your Property Address (e.g. 142 Church St, Parramatta)"
                  className="w-full px-4 py-2.5 bg-slate-50 rounded-lg text-sm border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0a192f]"
                />
