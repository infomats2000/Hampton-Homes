...
**Current platform**: DigitalOcean Managed PostgreSQL, accessed from Google Cloud Run.
...
2. Add DATABASE_URL to .env.local and Google Secret Manager
...
**Environment Variables needed:**
  ...
  NEXTAUTH_URL=https://infomats-realestate.web.app

---

### 1.3 Cloud Run Environment Variables

**Problem**: Production requires runtime configuration for integrations, authentication, and database access.
**Solution**: Store secrets in Google Secret Manager and non-secret configuration in Cloud Run environment variables.
...
**Full variable list:**
  ...
  # Public
  NEXT_PUBLIC_SITE_URL=https://infomats-realestate.web.app
...
- [NEW] src/app/api/cron/mri-sync/route.ts — Cloud Scheduler target
- [CONFIGURE] Google Cloud Scheduler — invoke `/api/cron/mri-sync` every 15 minutes
...
- [CONFIGURE] Google Cloud Scheduler — invoke `/api/cron/saved-search-alerts` daily at 08:00
...
## Recommended Implementation Order
  ...
  Week 1 — Foundation:
    ...
    Phase 1.3 — Cloud Run Environment Variables
